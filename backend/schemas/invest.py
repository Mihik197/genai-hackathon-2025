...
class MarketDataAnalysisOutput(BaseModel):
    """Output schema for Data Analyst agent"""
    ...
    executive_summary: List[str] = Field(description="3-5 key bullet points")
    ...
    analyst_ratings_summary: Optional[str] = Field(None, description="Summary of analyst opinions if found")
